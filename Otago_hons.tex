...
%\onehalfspacing
%\doublespace 
 {\Huge \bfseries Thermalisation of Ultracold Bose Gases on Optical Lattices}  \\[3cm]
 
 
 
 %\huge{noice dissertation}

%\endgroup
\Huge{Nikolas M. Mitchell}\\[3.5cm]


\Large{September 2017}\\[1.5cm]

\large{A dissertation submitted in partial fulfilment for  \\
the degree of Bachelor of Science with Honours in Physics}\\[1.1cm]


\includegraphics[width=0.2\textwidth]{OtagoLogo-eps-converted-to.pdf}
