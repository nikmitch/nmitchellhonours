...
parameters = {
    ...
    "Exported quantities":             {"d2": None, "n": None, "fk": None, "fkRigol": None}
    }
...
if __name__ == "__main__":
    ...
    qmio.export_spectrum(parameters, spectrum)

    # Prepare initial state of the time evolution (all particles on first site)
